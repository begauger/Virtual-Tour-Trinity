...
export default function TourSeventhEighth() {
  ...
  return (
    ...
    >
      ...
      >
        <img
          src="/seventhgradeteacher.jpg"
          alt="Seventh and Eighth Grade Teacher"
          style={{
            ...
            borderRadius: "1.2rem",
            objectFit: "cover",
            boxShadow: "0 10px 38px 0 rgba(37, 99, 235, 0.16)",
            background: "#fff",
        ...
        >
          Ms. Sue Schachtschneider
        </div>
        <button
          onClick={() => navigate("/tour-end")}
          style={{
            marginTop: "2.2rem",
      ...
      >
        ...
        >
          Welcome to Our Seventh &amp; Eighth Grade Room!
        </h2>
        <div
          style={{
        ...
        >
          <img
            ...
            alt={`Seventh & Eighth Grade Slide ${slide + 1}`}
            style={{
              width: "100%",
              height: "100%",
              objectFit: "cover",
